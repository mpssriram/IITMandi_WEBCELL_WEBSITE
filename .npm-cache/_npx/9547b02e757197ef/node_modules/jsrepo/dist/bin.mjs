...
`)}`)}}else{if(i.mainObjectExpression===null)return(0,G.err)(new Le);let t=r.slice(i.mainObjectExpression.start,i.mainObjectExpression.end).lastIndexOf(`,`),n=t===-1?-1:t+i.mainObjectExpression.start+1;if(i.mainObjectExpression.properties.length===0)r.appendRight(i.mainObjectExpression.start+1,`\n\tpaths: {\n${Object.entries(e).map(([e,t])=>`\t\t${ne.test(e)?e:`'${e}'`}: '${t}'`).join(`,
...
${e.map(e=>`   ${Gt(e)}`).join(`
`)}`}function Gt(e){if(e.isErr())return`${K.default.cyan(e.error.registryName)}: ${K.default.red(e.error.toString())}`;let{name:t,outputs:n,time:r,items:i,files:a}=e.value;return`${K.default.cyan(t)}: Created ${K.default.green(n.toString())} ${n>1?`outputs`:`output`} in ${K.default.green(`${r.toFixed(2)}ms`)} with ${K.default.green(i.toString())} ${i>1?`items`:`item`} and ${K.default.green(a.toString())} ${a>1?`files`:`file`}.`}function Kt(e){let t=``;for(let n=0;n<e.length;n++){if(e[n]===`-`){n++,n<=e.length-1&&(t+=e[n].toUpperCase());continue}t+=e[n].toLocaleLowerCase()}return t}var qt=class{IGNORED_PROPERTIES=[`registry`,`registries`,`paths`];importDeclarations=[];withinExportDefaultDeclaration=!1;withinDefineConfig=!1;withinMainObjectExpression=!1;withinIgnoredProperty=!1;lastImportDeclaration=null;configKeyPropertyDeclaration=null;mainObjectExpression=null};async function Jt({plugins:e,key:t,config:n}){if(e.length===0)return(0,G.ok)(n.code);let r=await Je(n.path,n.code),i=new wt(n.code),a=new qt;if(a.withinDefineConfig=!0,new qe({ImportDeclaration(e){a.withinDefineConfig&&(a.lastImportDeclaration=e,a.importDeclarations.push(e))},ExportDefaultDeclaration(){a.withinExportDefaultDeclaration=!0},"ExportDefaultDeclaration:exit"(){a.withinExportDefaultDeclaration=!1},ObjectExpression(e){a.withinExportDefaultDeclaration&&a.withinDefineConfig&&(a.withinIgnoredProperty||(a.withinMainObjectExpression||=(a.mainObjectExpression=e,!0)))},CallExpression(e){a.withinExportDefaultDeclaration&&e.callee.type===`Identifier`&&e.callee.name===`defineConfig`&&(a.withinDefineConfig=!0)},"CallExpression:exit"(e){a.withinDefineConfig&&e.callee.type===`Identifier`&&e.callee.name===`defineConfig`&&(a.withinDefineConfig=!1,a.withinMainObjectExpression=!1)},Property(e){if(a.withinDefineConfig&&a.withinMainObjectExpression&&!a.withinIgnoredProperty){if(a.IGNORED_PROPERTIES.includes(e.key.type===`Identifier`?e.key.name:``)){a.withinIgnoredProperty=!0;return}if(e.key.type===`Identifier`&&(e.kind===`init`||e.kind===`get`)&&e.key.name===t){if(e.value.type!==`ArrayExpression`)return(0,G.err)(new Ie({key:t,type:`array`}));a.configKeyPropertyDeclaration=e}}},"Property:exit"(e){if(a.withinDefineConfig&&a.IGNORED_PROPERTIES.includes(e.key.type===`Identifier`?e.key.name:``)){a.withinIgnoredProperty=!1;return}}}).visit(r.program),e=e.filter(e=>!a.importDeclarations.some(t=>t.source.value===e.packageName)),e.length===0)return(0,G.ok)(n.code);a.lastImportDeclaration!==null&&i.appendRight(a.lastImportDeclaration.end,e.map(e=>`\nimport ${e.name} from '${e.packageName}';`).join(``));let o=null;t===`providers`?o=`DEFAULT_PROVIDERS`:t===`languages`&&(o=`DEFAULT_LANGS`);let s=a.importDeclarations.find(e=>e.source.value===`jsrepo`);if(s===void 0)return(0,G.err)(new Ne);let c=o?{added:!1,name:o}:null;if(c!==null){for(let e of s.specifiers)if(e.type===`ImportSpecifier`&&e.imported.type===`Identifier`&&e.imported.name===o){c.added=!0,e.local.name!==o&&(c.name=e.local.name);break}}if(a.configKeyPropertyDeclaration!==null){if(a.configKeyPropertyDeclaration.value.type!==`ArrayExpression`)return(0,G.err)(new Ie({key:t,type:`array`}));let n=i.slice(a.configKeyPropertyDeclaration.value.start,a.configKeyPropertyDeclaration.value.end).lastIndexOf(`,`),r=n===-1?-1:n+a.configKeyPropertyDeclaration.value.start+1;if(a.configKeyPropertyDeclaration.value.elements.length===0)c=null,i.appendRight(a.configKeyPropertyDeclaration.value.start+1,`${e.map(e=>`${e.name}()`).join(`, `)}`);else{let t=a.configKeyPropertyDeclaration.value.elements[a.configKeyPropertyDeclaration.value.elements.length-1],n=!1;n=!(r!==-1&&r>t.end),c=null,i.appendRight(n?t.end:r,`${n?`,`:``} ${e.map(e=>`${e.name}()`).join(`, `)}`)}}else{if(a.mainObjectExpression===null)return(0,G.err)(new Le);let n=i.slice(a.mainObjectExpression.start,a.mainObjectExpression.end).lastIndexOf(`,`),r=n===-1?-1:n+a.mainObjectExpression.start+1;if(a.mainObjectExpression.properties.length===0)i.appendRight(a.mainObjectExpression.start+1,`\n\t${t}: [${c?`...${c.name}, `:``}${e.map(e=>`${e.name}()`).join(`, `)}]`);else{let n=a.mainObjectExpression.properties[a.mainObjectExpression.properties.length-1],o=!1;o=!(r!==-1&&r>n.end),i.appendRight(o?n.end:r,`${o?`,`:``}\n\t${t}: [${c?`...${c.name}, `:``}${e.map(e=>`${e.name}()`).join(`, `)}]`)}if(c&&!c.added){let e=i.slice(s.start,s.end).lastIndexOf(`,`),t=e===-1?-1:e+s.start+1,n=s.specifiers[s.specifiers.length-1],r=!1;r=!(t!==-1&&t>n.end),i.appendRight(r?n.end:t,`${r?`,`:``} ${c.name}`)}}return(0,G.ok)(i.toString())}async function Yt({plugins:e,config:t}){let n=await v(t.code,{fileName:t.path,warn:A});return e.filter(e=>!n.includes(e.package))}const Xt=[{shorthand:`prettier`,name:`@jsrepo/transform-prettier`},{shorthand:`biome`,name:`@jsrepo/transform-biome`},{shorthand:`javascript`,name:`@jsrepo/transform-javascript`},{shorthand:`oxfmt`,name:`@jsrepo/transform-oxfmt`},{shorthand:`filecasing`,name:`@jsrepo/transform-filecasing`}];function Zt(e,t){let n=e.map(e=>Qt(e,t)),r=[];for(let e of n){if(e.isErr())return(0,G.err)(e.error);r.push(e.value)}return(0,G.ok)(r)}function Qt(e,t){let n=Xt.find(t=>t.shorthand===e);if(n){let e=Qt(n.name,t);return e.isErr()?(0,G.err)(e.error):(0,G.ok)({name:e.value.name,packageName:n.name,version:void 0})}let r=k(e);if(r.isErr())return(0,G.err)(new Me(e));let i=r.value.name;return r.value.name.startsWith(`@`)&&(i=r.value.name.startsWith(`@jsrepo/`)?r.value.name.split(`/`)[1]?.includes(t)?`jsrepo-${r.value.name.split(`/`)[1]}`:`jsrepo-${t}-${r.value.name.split(`/`)[1]}`:r.value.name.split(`/`)[1]),(0,G.ok)({name:Kt(i.replace(`jsrepo-${t}-`,``)),packageName:r.value.name,version:r.value.version})}const $t=q.extend({yes:N()}),en=new W(`language`).description(`Add a language to your config.`).argument(`[languages...]`,`Names of the languages you want to add to your config. ex: (jsrepo-language-go, jsrepo-language-rust)`).addOption(J.cwd).addOption(J.yes).action(async(e,t)=>{let n=Y($t,t),r=await f({cwd:n.cwd,promptForContinueIfNull:!n.yes});r||Z(new ze(n.cwd));let i=r.config,a=I.dirname(r.path),o={...n,cwd:a};await Q(i,{command:`config.language`,options:o},{cwd:a,yes:n.yes}),u();let s=await X(tn(e,o,r));z(nn(s)),await $(i,{command:`config.language`,options:o,result:s},{cwd:a})});async function tn(e,t,n){let r=performance.now(),i=Zt(e,`language`);if(i.isErr())return(0,G.err)(i.error);let a=i.value,o=w(n.path);if(o.isErr())return(0,G.err)(o.error);let s=o.value,c=await Jt({plugins:a,key:`languages`,config:{path:n.path,code:s}});if(c.isErr())return(0,G.err)(c.error);let l=c.value,u=P(n.path,l);return u.isErr()?(0,G.err)(u.error):(await x({devDependencies:a.map(e=>({name:e.packageName,version:e.version})),dependencies:[]},{options:t,configPath:n.path}),(0,G.ok)({duration:performance.now()-r,languages:e.length}))}function nn({duration:e,languages:t}){return`Added ${K.default.green(t.toString())} ${t>1?`languages`:`language`} in ${K.default.green(`${e.toFixed(2)}ms`)}.`}const rn=[`cursor`,`claude`,`vscode`,`codex`,`antigravity`],an=q.extend({client:oe(ce(rn)).optional(),all:N().optional()}),on=new W(`mcp`).description(`Configure the jsrepo MCP server for your environment.`).addOption(new We(`--client <clients...>`,`The MCP client(s) to configure`).choices(rn)).option(`--all`,`Configure all supported MCP clients`,!1).addOption(J.cwd).action(async e=>{let t=Y(an,e),n=(await f({cwd:t.cwd,promptForContinueIfNull:!1}))?.config??{},r=t.cwd;await Q(n,{command:`config.mcp`,options:t},{cwd:r,yes:!1}),u();let i=await X(sn(t));z(cn({...i,cwd:t.cwd})),await $(n,{command:`config.mcp`,options:t,result:i},{cwd:r})});async function sn(e){let t;if(e.all)t=Object.keys(bn);else if(e.client&&e.client.length>0)t=e.client;else{let e=await H({message:`Which clients would you like to configure?`,options:Object.entries(bn).map(([e,t])=>({value:e,label:t.name}))});R(e)&&(V(`Canceled!`),process.exit(0)),t=e}let n=performance.now(),r=[];for(let n of t){let t=bn[n],i=t.filePath(e.cwd),a=t.writeConfig(i);r.push({name:t.name,result:a.isErr()?(0,G.err)(a.error):(0,G.ok)({filePath:i})})}return(0,G.ok)({duration:performance.now()-n,results:r})}function cn({duration:e,results:t,cwd:n}){return`Configured ${t.length} ${t.length>1?`clients`:`client`} in ${K.default.green(`${e.toFixed(2)}ms`)}:\n${t.map(e=>ln(e,n)).join(`
`)}`}function ln({name:e,result:t},n){if(t.isErr())return`   ${K.default.cyan(e)}: ${K.default.red(t.error.message)}`;let{filePath:r}=t.value;return`   ${K.default.cyan(e)} → ${K.default.dim(I.relative(n,r))}`}function un(e,t){try{return P(e,t),(0,G.ok)(void 0)}catch(t){return(0,G.err)(new U(`Failed to write config to ${e}: ${t instanceof Error?t.message:String(t)}`,{suggestion:`Please try again.`}))}}const dn={command:`npx`,args:[`@jsrepo/mcp`]},fn=`[mcp_servers.jsrepo]
command = "npx"
args = ["@jsrepo/mcp"]
`;function pn(e){return e?e.includes(`[mcp_servers.jsrepo]`)?e:(e.endsWith(`
`)||(e+=`
`),`${e}${fn}`):fn}const mn=C({command:L().optional(),args:oe(L()).optional(),env:ge(L(),L()).optional(),type:L().optional(),url:L().optional(),headers:ge(L(),L()).optional()}).catchall(E()),hn=C({mcpServers:ge(L(),mn)}),gn=C({servers:ge(L(),mn)});function _n({existingContent:e,serverName:t,serverConfig:n}){if(e.trim().length===0)return(0,G.ok)(l({mcpServers:{[t]:n}},{format:!0}));let r=D(hn,e);return r.isErr()?(0,G.err)(new U(`Failed to parse MCP server config: ${r.error.message}`,{suggestion:`Please try again.`})):(0,G.ok)(l({mcpServers:{...r.value.mcpServers,[t]:n}},{format:!0}))}function vn({existingContent:e,serverName:t,serverConfig:n}){if(e.trim().length===0)return(0,G.ok)(l({servers:{[t]:n}},{format:!0}));let r=D(gn,e);return r.isErr()?(0,G.err)(new U(`Failed to parse MCP server config: ${r.error.message}`,{suggestion:`Please try again.`})):(0,G.ok)(l({servers:{...r.value.servers,[t]:n}},{format:!0}))}function yn(e,t,n=`generic`){let r=te(e)?w(e)._unsafeUnwrap():``,i=n===`vscode`?vn({existingContent:r,serverName:`jsrepo`,serverConfig:t}):_n({existingContent:r,serverName:`jsrepo`,serverConfig:t});return i.isErr()?(0,G.err)(i.error):un(e,i.value)}const bn={cursor:{name:`Cursor`,filePath:e=>F(e,`.cursor/mcp.json`),writeConfig:e=>yn(e,dn)},claude:{name:`Claude Code`,filePath:e=>F(e,`.mcp.json`),writeConfig:e=>yn(e,dn)},vscode:{name:`VS Code`,filePath:e=>F(e,`.vscode/mcp.json`),writeConfig:e=>yn(e,dn,`vscode`)},codex:{name:`Codex`,filePath:()=>F(Ye.homedir(),`.codex/config.toml`),writeConfig:e=>un(e,pn(te(e)?w(e)._unsafeUnwrap():``))},antigravity:{name:`Antigravity`,filePath:()=>F(Ye.homedir(),`.gemini/antigravity/mcp_config.json`),writeConfig:e=>yn(e,dn)}},xn=q.extend({yes:N()}),Sn=new W(`provider`).description(`Add a provider to your config.`).argument(`[providers...]`,`Names of the providers you want to add to your config. ex: (jsrepo-provider-jsr, jsrepo-provider-npm)`).addOption(J.cwd).addOption(J.yes).action(async(e,t)=>{let n=Y(xn,t),r=await f({cwd:n.cwd,promptForContinueIfNull:!n.yes});r||Z(new ze(n.cwd));let i=r.config,a=I.dirname(r.path),o={...n,cwd:a};await Q(i,{command:`config.provider`,options:o},{cwd:a,yes:n.yes}),u();let s=await X(Cn(e,o,r));z(wn(s)),await $(i,{command:`config.provider`,options:o,result:s},{cwd:a})});async function Cn(e,t,n){let r=performance.now(),i=Zt(e,`provider`);if(i.isErr())return(0,G.err)(i.error);let a=i.value,o=w(n.path);if(o.isErr())return(0,G.err)(o.error);let s=o.value,c=await Jt({plugins:a,key:`providers`,config:{path:n.path,code:s}});if(c.isErr())return(0,G.err)(c.error);let l=c.value,u=P(n.path,l);return u.isErr()?(0,G.err)(u.error):(await x({devDependencies:a.map(e=>({name:e.packageName,version:e.version})),dependencies:[]},{options:t,configPath:n.path}),(0,G.ok)({duration:performance.now()-r,providers:e.length}))}function wn({duration:e,providers:t}){return`Added ${K.default.green(t.toString())} ${t>1?`providers`:`provider`} in ${K.default.green(`${e.toFixed(2)}ms`)}.`}const Tn=q.extend({yes:N()}),En=new W(`transform`).description(`Add a transform to your config.`).argument(`[transforms...]`,`Names of the transforms you want to add to your config. ex: (@jsrepo/transform-prettier, @jsrepo/transform-biome)`).addOption(J.cwd).addOption(J.yes).action(async(e,t)=>{let n=Y(Tn,t),r=await f({cwd:n.cwd,promptForContinueIfNull:!n.yes});r||Z(new ze(n.cwd));let i=r.config,a=I.dirname(r.path),o={...n,cwd:a};await Q(i,{command:`config.transform`,options:o},{cwd:a,yes:n.yes}),u();let s=await X(Dn(e,o,r));z(On(s)),await $(i,{command:`config.transform`,options:o,result:s},{cwd:a})});async function Dn(e,t,n){let r=performance.now(),i=Zt(e,`transform`);if(i.isErr())return(0,G.err)(i.error);let a=i.value,o=w(n.path);if(o.isErr())return(0,G.err)(o.error);let s=o.value,c=await Jt({plugins:a,key:`transforms`,config:{path:n.path,code:s}});if(c.isErr())return(0,G.err)(c.error);let l=c.value,u=P(n.path,l);return u.isErr()?(0,G.err)(u.error):(await x({devDependencies:a.map(e=>({name:e.packageName,version:e.version})),dependencies:[]},{options:t,configPath:n.path}),(0,G.ok)({duration:performance.now()-r,transforms:e.length}))}function On({duration:e,transforms:t}){return`Added ${K.default.green(t.toString())} ${t>1?`transforms`:`transform`} in ${K.default.green(`${e.toFixed(2)}ms`)}.`}const kn=new W(`config`).description(`Modify your jsrepo config.`).addCommand(En).addCommand(Sn).addCommand(en).addCommand(on);var An=class{withinExportDefaultDeclaration=!1;withinDefineConfig=!1;withinMainObjectExpression=!1;withinIgnoredProperty=!1;configKeyPropertyDeclaration=null;mainObjectExpression=null};async function jn(e,{config:t}){if(e.length===0)return(0,G.ok)(t.code);let n=await Je(t.path,t.code),r=new wt(t.code),i=new An;if(i.withinDefineConfig=!0,new qe({ExportDefaultDeclaration(){i.withinExportDefaultDeclaration=!0},"ExportDefaultDeclaration:exit"(){i.withinExportDefaultDeclaration=!1},ObjectExpression(e){i.withinExportDefaultDeclaration&&i.withinDefineConfig&&(i.withinIgnoredProperty||(i.withinMainObjectExpression||=(i.mainObjectExpression=e,!0)))},CallExpression(e){i.withinExportDefaultDeclaration&&e.callee.type===`Identifier`&&e.callee.name===`defineConfig`&&(i.withinDefineConfig=!0)},"CallExpression:exit"(e){i.withinDefineConfig&&e.callee.type===`Identifier`&&e.callee.name===`defineConfig`&&(i.withinDefineConfig=!1,i.withinMainObjectExpression=!1)},Property(e){if(i.withinDefineConfig&&i.withinMainObjectExpression&&!i.withinIgnoredProperty){if(e.key.type===`Identifier`&&e.key.name!==`registries`){i.withinIgnoredProperty=!0;return}if(e.key.type===`Identifier`&&(e.kind===`init`||e.kind===`get`)&&e.key.name===`registries`){if(e.value.type!==`ArrayExpression`)return(0,G.err)(new Ie({key:`registries`,type:`array`}));i.configKeyPropertyDeclaration=e}}},"Property:exit"(e){if(i.withinDefineConfig&&e.key.type===`Identifier`&&e.key.name!==`registries`){i.withinIgnoredProperty=!1;return}}}).visit(n.program),i.configKeyPropertyDeclaration!==null){if(i.configKeyPropertyDeclaration.value.type!==`ArrayExpression`)return(0,G.err)(new Ie({key:`registries`,type:`array`}));for(let t of i.configKeyPropertyDeclaration.value.elements)!t||t.type!==`Literal`||typeof t.value==`string`&&(e=e.filter(e=>e!==t.value));if(e.length===0)return(0,G.ok)(t.code);let n=r.slice(i.configKeyPropertyDeclaration.value.start,i.configKeyPropertyDeclaration.value.end).lastIndexOf(`,`),a=n===-1?-1:n+i.configKeyPropertyDeclaration.value.start+1;if(i.configKeyPropertyDeclaration.value.elements.length===0)r.appendRight(i.configKeyPropertyDeclaration.value.start+1,`${e.map(e=>`'${e}'`).join(`, `)}`);else{let t=i.configKeyPropertyDeclaration.value.elements[i.configKeyPropertyDeclaration.value.elements.length-1],n=!1;n=!(a!==-1&&a>t.end),r.appendRight(n?t.end:a,`${n?`,`:``} ${e.map(e=>`'${e}'`).join(`, `)}`)}}else{if(i.mainObjectExpression===null)return(0,G.err)(new Le);let t=r.slice(i.mainObjectExpression.start,i.mainObjectExpression.end).lastIndexOf(`,`),n=t===-1?-1:t+i.mainObjectExpression.start+1;if(i.mainObjectExpression.properties.length===0)r.appendRight(i.mainObjectExpression.start+1,`\n\tregistries: [${e.map(e=>`'${e}'`).join(`, `)}]`);else{let t=i.mainObjectExpression.properties[i.mainObjectExpression.properties.length-1],a=!1;a=!(n!==-1&&n>t.end),r.appendRight(a?t.end:n,`${a?`,`:``}\n\tregistries: [${e.map(e=>`'${e}'`).join(`, `)}]`)}}return(0,G.ok)(r.toString())}const Mn=q.extend({yes:N(),overwrite:N(),verbose:N(),expand:N(),maxUnchanged:M(),js:N()}),Nn=new W(`init`).description(`Initialize a new jsrepo project.`).argument(`[registries...]`,`The registries to initialize.`).option(`--js`,`Initialize the project and automatically add the @jsrepo/transform-javascript transform plugin.`,!1).addOption(J.cwd).addOption(J.yes).addOption(J.verbose).addOption(J.overwrite).addOption(J.expand).addOption(J.maxUnchanged).action(async(e,t)=>{let n=Y(Mn,t),r=await f({cwd:n.cwd,promptForContinueIfNull:!1}),i=r?.config??{},a=r?I.dirname(r.path):n.cwd;await Q(i,{command:`init`,options:{...n,cwd:a}},{cwd:a,yes:n.yes}),u();let o=await X(Pn(e,{...n,cwd:a},r));z(K.default.green(`Initialization complete!`)),await $(i,{command:`init`,options:{...n,cwd:a},result:o},{cwd:a})});async function Pn(e,t,n){let{verbose:r,spinner:i}=le({options:t}),a=F(t.cwd,`package.json`),s=se(a);if(s.isErr())return(0,G.err)(new Re);let c=s.value,{config:l,path:u}=n??{config:null,path:F(t.cwd,c.type===`module`?`jsrepo.config.ts`:`jsrepo.config.mts`)},f=l?.providers??fe,p;if(l===null)p=zn();else{let e=w(u);if(e.isErr())return(0,G.err)(e.error);p=e.value}let h=!0;if(c.dependencies?.jsrepo===void 0&&c.devDependencies?.jsrepo===void 0){c.devDependencies||={},c.devDependencies.jsrepo=`^${_}`;let e=P(a,JSON.stringify(c,null,`	`));if(e.isErr())return(0,G.err)(e.error);h=!1}if(t.js){let e=await Jt({plugins:[{name:`stripTypes`,packageName:`@jsrepo/transform-javascript`,version:void 0}],key:`transforms`,config:{path:u,code:p}});if(e.isErr())return(0,G.err)(e.error);p=e.value}if(e.length===0){if(l!==null)return(0,G.err)(new Be);let e=P(u,p);return e.isErr()?(0,G.err)(e.error):(B.success(`Wrote config to ${K.default.cyan(I.relative(t.cwd,u))}`),h||await x({dependencies:[],devDependencies:[...t.js?[{name:`@jsrepo/transform-javascript`}]:[]]},{configPath:u,options:t}),(0,G.ok)({registries:[]}))}let g=e.length>0?e:l?.registries??[];i.start(`Retrieving manifest${g.length>1?`s`:``} from ${K.default.cyan(g.join(`, `))}`);let v=await T(g,{cwd:t.cwd,providers:f});if(v.isErr())return i.stop(`Failed to retrieve manifests`),(0,G.err)(v.error);i.stop(`Retrieved manifest${g.length>1?`s`:``} from ${K.default.cyan(g.join(`, `))}`);let b=v.value,S=new Map;for(let[e,n]of b){let e=await Fn(n,{configCode:p,configPath:u,options:t,pluginChoices:S,config:l});if(e.isErr())return(0,G.err)(e.error);p=e.value}let C=await jn(e,{config:{path:u,code:p}});if(C.isErr())return(0,G.err)(C.error);p=C.value;let E=P(u,p);if(E.isErr())return(0,G.err)(E.error);B.success(`Wrote config to ${K.default.cyan(I.relative(t.cwd,u))}`);let D=new Map(Array.from(S.values()).filter(e=>e.install).map(e=>[`js:${e.plugin.packageName}@${e.plugin.version??``}`,{name:e.plugin.packageName,version:e.plugin.version,ecosystem:`js`}]));D.size>0&&await x({dependencies:[],devDependencies:[...Array.from(D.values()),...t.js?[{name:`@jsrepo/transform-javascript`}]:[]]},{options:{yes:!0},configPath:u}),D.clear();let O=await d({cwd:I.parse(u).dir});if(O.isErr())return(0,G.err)(O.error);l=O.value;let k=Array.from(b.values()).flatMap(e=>e.manifest.items.filter(e=>e.add===`on-init`||e.name===`index`).map(t=>({registry:e,item:t}))),A=Array.from(b.values()).flatMap(e=>e.manifest.items.filter(e=>e.add===`optionally-on-init`).map(t=>({registry:e,item:t})));if(A.length>0){let e=await H({message:`Would you like to add any of the following items?`,options:A.map(e=>({label:e.item.name,value:e.item.name})),required:!1});R(e)&&(V(`Canceled!`),process.exit(0)),k.push(...A.filter(t=>e.includes(t.item.name)))}let j={dependencies:[],devDependencies:[]};if(k.length>0){i.start(`Fetching ${K.default.cyan(k.map(e=>e.item.name).join(`, `))}...`);let e=await ye(k);if(e.isErr())return i.stop(`Failed to fetch items`),(0,G.err)(e.error);i.stop(`Fetched ${K.default.cyan(k.map(e=>e.item.name).join(`, `))}`);let n=e.value,r=await ae({items:n,config:l,options:t});if(r.isErr())return(0,G.err)(r.error);let{itemPaths:a}=r.value,s=await he({configResult:{path:u,config:l},options:{cwd:t.cwd,yes:t.yes},itemPaths:a,items:n});if(s.isErr())return(0,G.err)(s.error);let{neededDependencies:c,neededEnvVars:d,neededFiles:f}=s.value,p=await o({files:f,options:t});if(p.isErr())return(0,G.err)(p.error);let m=p.value;if(B.success(`Updated ${K.default.green(m.length)} files`),d){let e=await y(d,{options:t});e&&B.success(`Updated ${K.default.green(Object.keys(e).length)} environment variables`)}j.dependencies.push(...c.dependencies),j.devDependencies.push(...c.devDependencies)}if(l.paths!==void 0){let e=await Et(l.paths,{config:{path:u,code:p}});if(e.isErr())return(0,G.err)(e.error);p=e.value;let t=P(u,p);if(t.isErr())return(0,G.err)(t.error);B.success(`Updated paths`)}return await m(j,{options:t,config:l}),(0,G.ok)({registries:e})}async function Fn(e,{configCode:t,configPath:n,options:r,pluginChoices:i,config:a}){let o=await In(e,{configCode:t,configPath:n,options:r,pluginChoices:i});if(o.isErr())return(0,G.err)(o.error);t=o.value;let s=await Ln(e,{configCode:t,configPath:n,options:r,config:a});return s.isErr()?(0,G.err)(s.error):(t=s.value,(0,G.ok)(t))}async function In(e,{configCode:t,configPath:n,options:r,pluginChoices:i}){if(!e.manifest.plugins)return(0,G.ok)(t);for(let[a,o]of Object.entries(e.manifest.plugins)){let e=await Rn(o,{pluginChoices:i,options:r,type:a.slice(0,-1),config:{path:n,code:t}});if(e.isErr())return(0,G.err)(e.error);let s=e.value,c=await Jt({plugins:s,key:a,config:{path:n,code:t}});if(c.isErr())return(0,G.err)(c.error);t=c.value}return(0,G.ok)(t)}async function Ln(e,{configCode:t,configPath:n,config:r,options:i}){let a=Array.from(new Set(e.manifest.items.flatMap(e=>e.files.filter(e=>e.target===void 0).map(e=>j(e.type))))),o=r?.paths??{};if(!i.yes&&a.length>0){let t=await H({message:`Which paths would you like to configure?`,options:a.map(t=>({label:t,value:t,hint:e.manifest.defaultPaths?.[t]?`Default: ${e.manifest.defaultPaths?.[t]}`:void 0})),required:!1});if(R(t)&&(V(`Canceled!`),process.exit(0)),t.length>0)for(let n of t){let t=o[n]??e.manifest.defaultPaths?.[n],r=await Ce({message:`Where should ${n} be added in your project?`,validate(e){if(!e||e.trim()===``)return`Please provide a value`},placeholder:t||`./src/${n}`,defaultValue:t,initialValue:t});R(r)&&(V(`Canceled!`),process.exit(0)),o[n]=r}}return o={...e.manifest.defaultPaths,...o},await Et(o,{config:{path:n,code:t}})}async function Rn(e,{pluginChoices:t,options:n,type:r,config:i}){let a=[],o=(e,n)=>{t.set(e.packageName,{install:n,plugin:e}),a.push(e)},s=await Yt({config:i,plugins:e});for(let e of s){if(t.has(e.package))continue;let i=Qt(e.package,r);if(i.isErr())return(0,G.err)(i.error);let a={name:i.value.name,packageName:e.package,version:e.version};if(e.optional!==!0){o(a,!0);continue}let s=n.yes;if(!n.yes){let t=await Te({message:`Would you like to add the ${K.default.cyan(e.package)} ${r} plugin?`});R(t)&&(V(`Canceled!`),process.exit(0)),s=t}if(!s){t.set(e.package,{install:!1,plugin:a});continue}o(a,!0)}return(0,G.ok)(a)}function zn(){return`import { defineConfig } from 'jsrepo';
